...
namespace Engine
{
    public class Player : Creature
    {
        ...
        public bool HasRequiredItemToEnterThisLocation(Location location)
        {
            ...
            // See if the player has the required item intheir inventory
        ...
        {
            // See if the player has all the items neededto complete the quest here
            ...
            // If we got here, then the player must have all the requireditems, and enough of them, to complete the quest.
            return true;
        }
        public void RemoveQuestCompletionItems(Quest quest)
        {
            foreach (QuestCompletionItem qci in quest.QuestCompletionItems)
            {
                foreach (InventoryItem ii in Inventory)
                {
                    if (ii.Details.ID == qci.Details.ID)
                    {
                        // Subtract the quantity from the player'sinventory that was needed to complete the quest
        ...
        public void MarkQuestCompleted(Quest quest)
        {
            ...
            foreach (PlayerQuest pq in Quests)
            {
                if (pq.Details.ID == quest.ID)
                {
                    ...
                    pq.IsCompleted = true;
                    // We found the quest, and marked it complete, so getout of this function
                    return;
                }
            }
        }
